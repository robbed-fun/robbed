-- 0008 — display fields extracted from fetched metadata JSON (indexer.md §6.1
-- step 5, reworked per the §7.3 OI-11 verdict: external UPDATEs into the
...
-- as the §12.48c confirmation-state rework. The API card/detail projections
...
-- populates them; the Trust panel badges mismatches (indexer.md §3.1).
-- Idempotent; applies to schema `public` (offchain core, §7.3).
