...
/**
 * RATE_LIMIT_SCALE multiplies every configured per-route limit (windows unchanged).
 * Default 1 = production values. Never a bypass — 0/negative/NaN clamp to 1.
 * Uploads are deliberately not part of this table.
 */
