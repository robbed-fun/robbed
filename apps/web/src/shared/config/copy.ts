...
/**
 * Single re-export of the canonical LP sentence (spec §12.14; CLAUDE.md hard
...
/**
 * Approved AMM framing (spec §1): ROBBED_ is a bonding-curve AMM with soft
 ...
 * hoodpad-architect §12: hoodpad → ROBBED_). Titles/strings use this constant;
