...
- ABIs in `packages/shared/src/abi/` are codegen output from `contracts/script/codegen-abi.ts`, committed and consumed without a build step — regenerate, never hand-edit or paste locally.
