...
| OI-5 | V3 `Swap.recipient` is often a router, so per-EOA `total_eth_in/out` for v3 legs is approximate | — | **RESOLVED — D-16:** accepted; balances exact via Transfer, v3 cost basis best-effort until Phase 2 |
