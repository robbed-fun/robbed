...
--
-- pg_trgm powers the §5.1 search GIN indexes (name/ticker/address/creator trgm indexes,
-- indexer.md §3.1). The indexer's startup assertion (indexer.md §2) requires the extension
