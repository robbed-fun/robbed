...
/// in all contract logic (CLAUDE.md); any block-based logic must use
...
/// The anti-sniper window is timestamp-based; this interface is shipped for
/// tests and any future block-window need (contracts.md).
interface IArbSys {
